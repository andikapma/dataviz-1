...
Anda dapat membuat *chunk* kode R dengan cara klik tombol **Insert -- R** atau melalui pemintas **Ctrl + Alt + I**. Jika ingin menjalankan kode R dalam *chunck* tersebut, Anda dapat menggunakan pemintas **Ctrl + Enter** (menjalankan satu baris kode) atau **Ctrl + Shift + Enter** (menjalankan semua kode dalam *chunk*). Sekarang buat dan jalankanlah *chunk* baru yang isinya adalah baris kode R berikut:
