...
Sekarang Anda dapat mengubah grafik statis diatas menjadi animasi dengan menggunakan paket gganimate. Apa yang akan terjadi jika Anda menambahkan baris kode `transition_reveal(time)` pada plot_temperature?
